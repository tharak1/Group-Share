...
const FileCard:React.FC<FileCardProps> = ({chat}) => {
...
<div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">  
        <h5 className="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Sent on : {chat.dateSent}</h5>
    <p className="mb-3 font-lg text-gray-700 dark:text-gray-400">{chat.title}</p>

    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{chat.otherData}</p>
    {
        chat.fileAddress !== "none"?(
